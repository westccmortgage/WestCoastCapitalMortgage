...
Keeps the source page simple while ensuring Netlify can register all attribution
fields that script.js populates at submit time. Idempotent and scoped to one page.
"""
