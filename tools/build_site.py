...
<section class="founder-showcase" id="anatoliy"><div class="wrap">
  <div class="section-head center"><span class="eyebrow" style="color:var(--blue)">Real people behind the guidance</span></div>
  <div class="founder-grid">
    <div class="founder-photo"><img src="assets/anatoliy-kanevsky.png" alt="Anatoliy Kanevsky, founder of West Coast Capital Mortgage" loading="lazy"></div>
    <div>
      <h2>Anatoliy Kanevsky</h2>
      <p class="founder-role">Founder &bull; California Real Estate Broker</p>
      <p>Anatoliy Kanevsky is the founder of West Coast Capital Mortgage and a California real estate and mortgage professional with more than 20 years of experience helping borrowers, homeowners, Realtors, investors, and self-employed clients navigate real-world financing scenarios.</p>
      <p>His background combines mortgage lending, real estate brokerage, luxury residential development, and practical deal analysis. That experience shapes a company built around clear guidance, disciplined loan strategy, and real human review.</p>
      <ul class="founder-cred">
        <li>Founder, West Coast Capital Mortgage</li>
        <li>California Real Estate Broker &mdash; DRE #01385024</li>
        <li>Mortgage and real estate professional since 2004</li>
        <li>Purchase, refinance, jumbo, Non-QM, and DSCR experience</li>
