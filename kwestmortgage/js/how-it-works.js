/* ============================================================
   K West Mortgage — "How It Works" guided explainer
   5 live mini-demos with a guide + speech bubble + the real
   Financial Navigator voice (same takes as the guided tour).
...
(function () {
  ...
  /* ---- step bubbles (on-screen transcript) ---- */
  var BUBBLES = [
    "Hi, I’m your Financial Navigator — here to help you understand your options, no pressure. Let’s start with the county limit: in higher-cost areas like Monroe County (Key West) lenders draw a line, and below it your loan is “conforming,” above it you go “jumbo.” Drag the price and watch where the line is crossed.",
  ...
  // 1) Jumbo line — Monroe County sits at the high-cost ceiling.
  ...
  /* ---- voice: real Financial Navigator clips (same takes as the guided tour),
     one per step, instead of a robotic speech synthesizer ---- */
  var CLIPS = [
