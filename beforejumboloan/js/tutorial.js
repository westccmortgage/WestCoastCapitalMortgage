/* ============================================================
   BeforeJumboLoan — Guided Tool Tutorial (modular overlay)
   ------------------------------------------------------------
  ...
  var STEPS = [
    {
      ...
      body: "Choose the county where the property is located. Each county has its own loan-size limits, so this sets the baseline for everything that follows.",
    ...
    },
    {
      ...
      body: "Every county has a cut-off loan amount — and in higher-cost areas that line sits higher than most. Stay under it and your loan is a regular “conforming” loan; go over it and it becomes a bigger “jumbo” loan. This bar shows where your loan sits versus that line.",
    ...
    },
    {
      ...
      body: "Putting it all together, your scenario fits either conforming (under your county's limit) or jumbo (above it). Neither is automatically better — the goal is the most efficient structure for your situation.",
    ...
    },
    {
      ...
      body: "That's the full walkthrough. Mortgage financing is rarely about a single number — the strongest strategy comes from seeing how the factors work together. When you're ready, a licensed mortgage professional can review your scenario in detail. Everything here is educational — no credit pull, nothing sent anywhere.",
