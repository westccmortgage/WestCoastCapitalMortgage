...
**sister brand, Sun Coast Capital Mortgage**, generated from the same source. No build
...
- **`suncoast-corporate/`** — the deployable **Sun Coast Capital Mortgage** static site (Florida‑facing brand,
  operated through West Coast Capital Mortgage Inc.). Same page structure, navy + gold palette, Sun Coast
...
- **`tools/build_suncoast.py`** — Sun Coast sister generator. It **imports** `build_site.py` and reuses every
...
- Build command: *(none)*
- Publish directory: `wccm-corporate` (West Coast). For Sun Coast, create a second Netlify site with publish directory `suncoast-corporate`.
