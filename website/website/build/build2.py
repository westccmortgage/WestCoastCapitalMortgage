...
c += header("calc")
c += page_hero("Calculators","Mortgage Calculators","Estimate payments, test a refinance, check affordability, and weigh renting against buying — all updated live as you type.", bg=IMG['interior'])
c += f"""
...
a += header("apply")
a += page_hero("Apply Now","Apply Online in Minutes","A quick, secure application to get you pre-approved. No obligation — and a licensed loan officer reviews every submission personally.", bg=IMG['keys'])
a += f"""
<section class="section"><div class="container">
...
ct += header("contact")
ct += page_hero("Contact","Let's talk about your home loan","Questions about rates, programs, or your application? Reach out and a licensed loan officer will get back to you fast.", bg=IMG['porch'])
ct += f"""
<section class="section"><div class="container">
  <div class="split">
    <div>
